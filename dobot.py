...
# ============================================================
# CONVEYOR (pulses/sec — tune to taste)
# ============================================================
STP1_INDEX = 0
STP2_INDEX = 1
...
# ============================================================
# CONVEYOR (background thread)
# ============================================================
def run_conveyor_async(duration=5.0):
    def task():
...
# ============================================================
# VISION LOGIC (UNCHANGED — pure OpenCV/sklearn)
# ============================================================
...
def main():
    ...
    # Ensure stdout/stderr can encode non-ASCII messages from the Dobot DLL.
    try:
        import sys
        try:
    ...
    # If connection failed, enable preview-only mode so the script can run
    # without hardware attached (useful for development/testing).
        ...
        if not PREVIEW_ONLY:
            ...
            while trays_completed < MAX_TRAYS and remaining_cells:
                ...
                if not current_tray_needs:
                    ...
                    trays_completed += 1
                    run_conveyor_async(duration=5.0)
                else:
